            ...
            <div class="row">
                <div class="col-md-6 mt-lg-5 mb-lg-5 mt-md-3 mb-md-3 mt-sm-4 login-left">
                    <div class="mr-lg-5 ml-lg-2 mr-md-2 ml-md-1">
                        <div class="login-title"><h3>用戶登录 <span style="color:#41beda ">User login</span></h3></div>
                        <div class="search-content">
                            <form:form action="login" commandName="user" method="post">
                                <div class="form-group form-inline">
                                    <div class="col-lg-3 col-md-4 text-md-right">账号：</div>
                                    <div class="col-lg-9 col-md-8">
                                        <form:input type="text" path="adminId" class="w-100" style="height: 30px;" id="uname" />
                                        <span class="text-danger" id="uname_error"></span>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
                                    <div class="col-lg-3 col-md-4 text-md-right">密码：</div>
                                    <div class="col-lg-9 col-md-8">
                                        <form:input type="password" path="password" class="w-100" style="height: 30px;" id="pwd" />
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-lg-9 col-md-8">
                                        <a class="text-info" href="resetPwd">忘记密码？</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="ml-3 mr-3">
                                        <button type="submit" class="btn btn-block btn-info rounded-0">登&nbsp;&nbsp;录</button>
                                    </div>
                                </div>
                            </form:form>
                        </div>
                ...
                <div class="col-md-6 pt-lg-5 pb-lg-5 pt-md-3 pb-md-3 pb-3 bookmark">
                    <div class="pl-lg-2 pl-md-1 pl-sm-4 pr-sm-4">
                        ...
                        <div class="mt-4 text-info">还没有征信系统账号吗？</div>
                        <div class="form-group">
                            <div class="">
                                <a href="regist" class="btn btn-info rounded-0">&nbsp;&nbsp;&nbsp;&nbsp;立即注册&nbsp;&nbsp;&nbsp; &nbsp;</a>
                            </div>
                        </div>
                        <img src="static/images/creditreport.jpg" width="100%"/>
                    </div>
                </div>
            </div>
