            ...
            <div class="row" id="content_row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 right-column">
                    <div class="right-content">
                        <div class="right-title"><h3>银行卡信息三元素认证(新颜)</h3></div>
                        <div class="search-content">
                            <form:form action="bankcard3" commandName="bankCardModel" method="post">
                            	<input type="hidden" name="verifyElement" value="123"/>
                                ...
                                <div class="form-group form-inline">
                                    <label class="col-lg-3 col-md-4 control-label">姓名：<span class="text-danger">*</span></label>
