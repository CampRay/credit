            ...
            <div class="row" id="content_row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 right-column">
                    <div class="right-content">
                        <div class="right-title"><h3>银行卡信息认证(元素)</h3></div>
                        <div class="search-content">
                            <form:form action="elebankcard4" commandName="bankCardModel" method="post">                            	
                                <input type="hidden" name="service" value="card_fio"/>
								...
								<div class="form-group form-inline" id="div_mobile">
